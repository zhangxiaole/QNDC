			...
			<table class="tablesorter" cellspacing="0">
				<tbody>
					<fieldset>
						...
						<input type="text" id='userkey' name='userkey' value="<?php echo isset($puserkey)?$puserkey:"";?>">
					</fieldset>

					<fieldset>
						<label style="font-weight: bold;"><?php echo lang('plg_usersecret') ?></label></label><?php echo form_error('usersecret'); ?>
						<input type="text" id='usersecret' name='usersecret' value="<?php echo isset($pusersecret)?$pusersecret:"";?>">
					</fieldset>
				</tbody>
			</table>
		</div>
